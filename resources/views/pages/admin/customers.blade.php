...
@section('title', 'Customers | Loveby_Ade Admin')
@section('description', 'Review customer profiles, purchases, spending, and activity.')
        ...
        <header class="sticky top-0 z-20 border-b border-love-pink-100/80 bg-white/82 backdrop-blur-xl">
            <div class="flex flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-10">
                <div class="flex min-w-0 items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <h1 class="truncate text-2xl font-extrabold tracking-tight text-[#3b1728]">Customers</h1>
                        <p class="mt-1 truncate text-sm font-medium text-[#9a6c7b]">Review customer profiles, purchases, spending, and activity.</p>
                    </div>
                </div>

                <div class="flex items-center gap-3">
                    <label class="relative min-w-0 flex-1 sm:w-96 sm:flex-none" for="admin-customer-global-search">
                        ...
                        <input class="h-12 w-full rounded-full border border-love-pink-100 bg-white/88 px-12 text-sm font-medium text-[#512438] outline-none transition placeholder:text-[#9a6c7b] focus:border-love-pink-300 focus:ring-4 focus:ring-love-pink-100/80" id="admin-customer-global-search" type="search" placeholder="Search orders, products, customers..." data-customer-global-search>
                    </label>
