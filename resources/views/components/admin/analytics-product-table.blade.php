...
<section class="rounded-[1.25rem] border border-love-pink-100/70 bg-white/96 p-5 shadow-[0_22px_55px_-44px_rgba(81,36,56,0.42)]" data-analytics-table data-analytics-label="desserts">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
            <h2 class="text-2xl font-extrabold text-[#3b1728]">Product performance</h2>
            <p class="mt-1 text-sm font-medium text-[#9a6c7b]">Top-selling desserts and stock turnover.</p>
        </div>
        <label class="flex items-center gap-2 text-sm font-extrabold text-[#512438]" for="analytics-products-page-size">Rows<select class="h-10 rounded-full border border-love-pink-100 bg-white px-4 text-sm font-extrabold text-[#512438] outline-none transition focus:border-love-pink-300 focus:ring-4 focus:ring-love-pink-100/80" id="analytics-products-page-size" data-analytics-page-size><option value="6">6 rows</option><option value="9">9 rows</option><option value="12">12 rows</option></select></label>
    </div>

    <div class="mt-5 overflow-x-auto">
        <table class="w-full min-w-[42rem] border-separate border-spacing-y-2 text-left text-sm">
