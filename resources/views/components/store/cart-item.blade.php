...
<article class="grid gap-4 border-b border-love-pink-100/80 py-5 sm:grid-cols-[7.5rem_minmax(0,1fr)]" data-cart-item data-cart-price="{{ $price }}">
    ...
    <div class="min-w-0">
        ...
        <div class="mt-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="inline-flex w-max items-center gap-2 rounded-full border border-love-pink-100 bg-white p-1">
                ...
                <input class="h-9 w-12 rounded-full border-0 bg-transparent text-center text-sm font-extrabold text-slate-950 outline-none" type="number" min="1" max="20" value="{{ $quantity }}" aria-label="{{ $title }} quantity" data-cart-quantity-input>
