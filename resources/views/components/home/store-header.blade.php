<header class="fixed inset-x-0 top-0 z-50 border-b border-white/70 bg-white/90 shadow-[0_16px_40px_-32px_rgba(15,23,42,0.45)] backdrop-blur-xl">
    <div class="mx-auto flex max-w-[92rem] items-center gap-6 px-4 py-4 sm:px-6 lg:gap-10 lg:px-10">
        ...
        <label class="relative hidden max-w-xl flex-1 lg:block" for="site-search">
        ...
        <div class="ml-auto flex items-center gap-2 sm:gap-3 lg:gap-4">
            <button class="flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white/90 text-slate-600 transition hover:-translate-y-0.5 hover:border-love-pink-200 hover:text-love-pink-500" type="button" aria-label="Favorites">
                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
            ...
            <button class="flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white/90 text-slate-600 transition hover:-translate-y-0.5 hover:border-love-pink-200 hover:text-love-pink-500" type="button" aria-label="Notifications">
                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
            ...
            <button class="flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white/90 text-slate-600 transition hover:-translate-y-0.5 hover:border-love-pink-200 hover:text-love-pink-500" type="button" aria-label="Shopping cart">
                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
